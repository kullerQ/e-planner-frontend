export const messages = {
  ...
  tasks: {
    ...
    deleteConfirmDescription: 'Move "{title}" to Recycle Bin? You can undo this right after deletion.',
    deleteConfirmAction: 'Move to Recycle Bin',
    cancel: 'Cancel',
  ...
  bulkActions: {
    ...
    restoreError: 'Failed to restore selected tasks',
  },
  common: {
    cancel: 'Cancel',
    working: 'Working...',
  ...
  widgets: {
    todaysTasks: {
      ...
      confirmDeleteDescription: 'Move "{title}" to Recycle Bin? You can undo this right after deletion.',
    },
    monthCalendar: {
  ...
  settings: {
    ...
    logout: 'Log out',
    logoutTitle: 'Log out?',
    logoutWarning: 'You can sign back in anytime with your email and password.',
